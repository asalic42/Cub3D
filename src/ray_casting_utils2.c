...
/*   Updated: 2024/01/12 19:48:28 by rciaze           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	calculate_line_height(t_all_stuff_for_ray_casting *all_stuff, t_window *window)
{
	...
	if (all_stuff->dist_v < all_stuff->dist_t)
		all_stuff->line_h = (horizontal_blocksize * (HEIGHT)) / all_stuff->dist_t;
	else
		all_stuff->line_h = (vertical_blocksize * (HEIGHT)) / all_stuff->dist_t;
