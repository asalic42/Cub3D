...
/*   Updated: 2024/01/22 15:52:41 by asalic           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_textures(t_window *window, char *door)
{
	...
	mlx_string_put(mlx->mlx_ptr, mlx->win_ptr, 50, 50, 0xFF00AA, "Loading north texture ...");
	...
	mlx_string_put(mlx->mlx_ptr, mlx->win_ptr, 50, 100, 0xFF00AA, "Loading west texture ...");
	...
	textures->xpm2.xpm_data = mlx_get_data_addr(textures->xpm2.xpm,
			&tmp_p.bits_per_pixel, &tmp_p.size_line, &tmp_p.endian);
	mlx_string_put(mlx->mlx_ptr, mlx->win_ptr, 50, 150, 0xFF00AA, "Loading south texture ...");
	...
	textures->xpm3.xpm_data = mlx_get_data_addr(textures->xpm3.xpm,
			&tmp_p.bits_per_pixel, &tmp_p.size_line, &tmp_p.endian);
	mlx_string_put(mlx->mlx_ptr, mlx->win_ptr, 50, 200, 0xFF00AA, "Loading east texture ...");
	...
	mlx_string_put(mlx->mlx_ptr, mlx->win_ptr, 50, 250, 0xFF00AA, "Loading door texture...");
